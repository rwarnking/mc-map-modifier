...
class Identifier:
    ...
    def label_air_mp(self, classified_air_region):
    ...
    def label_water(self, classified_water_region):
    ...
    def label_repl(self, classified_repl_region):
    ...
    def identify(self, classified_air_region, classified_water_region, classified_repl_region):
        self.label_air_mp(classified_air_region)
        ...
        self.label_water(classified_water_region)

        self.label_repl(classified_repl_region)
